...
$article = array(
    'title' => 'Notice',
    'description' => 'Welcome to Websites of Front-end' 
); //key-value형태
...
<html>
    ...
    <body>
        ...
        <form action = "phpProcess_create.php" method = "POST"> <!--submit버튼을 클릭하면 action으로 이동. 데이터베이스에 입력하게끔 해줘야함-->
            <p><input type = "text" name = "title" placeholder = "title"></p> <!--placehoder : 텍스트 박스 안내사항(회색 글씨)-->
